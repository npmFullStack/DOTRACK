...
const NewTask = () => {
    ...
    const handleSubmit = e => {
        ...
        // Calculate expiresIn relative to current time
        const now = new Date();
        ...
        if (diffMinutes > 0) {
            if (diffMinutes < 60) {
                expiresIn = { value: diffMinutes, unit: "minutes" };
                ...
                expiresIn = {
                    value: Math.floor(diffMinutes / 1440),
                    unit: "days"
                };
            }
        }
        ...
        console.log(`Task will expire on ${expiresAt.toLocaleString()}`);
